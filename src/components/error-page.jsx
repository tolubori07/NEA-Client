  ...
  return (
    <>
      ...
      <div id="error-page" className="mt-12">
        <h1 className="text-mainAccent font-heading text-center text-5xl">
          Error 404
        </h1>
        <h1 className="text-main font-heading text-center text-3xl">
          Oops! The page you were looking for can't be found
        </h1>
        <h2 className="text-text font-heading text-center text-2xl">
          But here's something else you can do: {task.activity}
        </h2>
      </div>
    </>
  );
