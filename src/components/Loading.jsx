...
const Loading = () => {
  const facts = [
    "Human blood contains gold, just about 0.2mg though :(",
    "The human body makes about 2 million red blood cells a second ",
    " Mosquitoes prefer people with blood group O",
    ...
    " It would take 1,200,000 mosquitoes, each sucking once, to totally drain a human of blood.",
    "a blue whale’s heart only beats 5 times per minute while humans beat closer to 75 per minute.",
  ];
